...
/***/ function(module, exports, __webpack_require__) {
	...
	window.addEventListener('mousemove', function (event) {
	    exports.cursor.position.set(event.clientX + window.pageXOffset, event.clientY + window.pageYOffset);
	}, false);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ParticleSystem = (function () {
	    ...
	    ParticleSystem.prototype.populate = function () {
	        for (var i = 0; i < this.canvas.width * this.canvas.height / 20000 * this.options.density; i++) {
